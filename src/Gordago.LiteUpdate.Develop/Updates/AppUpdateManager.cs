/**
* @version $Id: AppUpdateManager.cs 4 2009-02-03 13:20:59Z AKuzmin $
* @package Gordago
* @copyright Copyright (C) 2008 Gordago. All rights reserved.
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
*/
namespace Gordago.LiteUpdate.Develop.Updates
{
  using System;
  ...
  class AppUpdateManager : UpdateManager {
    ...
    public AppUpdateManager() {
...
#if DEBUG
      LiteUpdate.Configure.UpdateUrl = "http://localhost/liteupdate";
#else
      ...
      LiteUpdate.Configure.ProductId = "LiteUpdateDevelop";

      LiteUpdate.Configure.ProductName = "LiteUpdate Develop";

      /* Корневая директория приложения */
      LiteUpdate.Configure.ApplicationDirectory = Global.Setup.AppDirectory;
